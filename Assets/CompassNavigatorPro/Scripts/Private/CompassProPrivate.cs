...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        private void OnValidate() {
            ...
            _miniMapResolutionNormalSize = Mathf.Max(_miniMapResolutionNormalSize, 2);
            needsSetupMiniMap = true;
        }
        ...
        void UpdateCompassBarContents() {
            ...
            Quaternion invRot;
            if (miniMapIsActive) {
                invRot = Quaternion.Inverse(miniMapFollow.rotation);
            } else {
                invRot = Quaternion.identity;
            }

            Vector3 followPos = miniMapFollow != null ? miniMapFollow.position : lastCamPos;
            ...
            for (int p = 0; p < icons.Count; p++) {
                ...
                if (!poi.isVisible) {
                    ...
                    // Check bending
                    if (_bendAmount == 0 && !_edgeFadeOut && activeIcon.image.material != null) {
                        activeIcon.image.material = null;
                    } else if ((_bendAmount != 0 || _edgeFadeOut) && activeIcon.image.material != curvedMat) {
        ...
        void UpdateMiniMap() {
            ...
            if (!miniMapCamera.orthographic || (_miniMapStyleFullScreenContents == MINIMAP_CONTENTS.WorldView && _miniMapZoomState) || (_miniMapContents == MINIMAP_CONTENTS.WorldView && !_miniMapZoomState)) {
                if (miniMapBackgroundTexRenderer != null) {
                ...
                if (miniMapBackgroundTexRenderer != null) {
                    if (_miniMapZoomState && _miniMapStyleFullScreenContentsTexture != null) {
                        ...
                        Vector3 size = miniMapFullScreenWorldSize;
                        size.y = 1f;
            ...
            if (miniMapMaterialRefresh && miniMapImage != null) {
                ...
                mat.SetVector(ShaderParams.Effects, new Vector4(_miniMapBrightness, _miniMapContrast, _miniMapLutIntensity));
