...
namespace Bootstrap
{
    ...
    {
        [Header("Game")]
        [SerializeField] private OutlineByRarenessRegistry _outlineByRarenessRegistry;
        ...
        [SerializeField] private InventoryRegistry _inventoryRegistry;
        ...
        {
            Container.InstallRegistry(_outlineByRarenessRegistry);
            ...
            Container.InstallRegistry(_inventoryRegistry);
